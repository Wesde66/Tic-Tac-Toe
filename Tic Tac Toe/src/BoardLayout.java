...
public class BoardLayout {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BoardLayout window = new BoardLayout();
	...
	private void initialize() {
		...
		textFieldPlayer1.setFont(new Font("Tahoma", Font.PLAIN, 15));
		textFieldPlayer1.setText("0");
		panel_5.add(textFieldPlayer1, BorderLayout.CENTER);
		...
		textFieldPlayer2.setFont(new Font("Tahoma", Font.PLAIN, 15));
		textFieldPlayer2.setText("0");
		panel_10.add(textFieldPlayer2, BorderLayout.CENTER);
